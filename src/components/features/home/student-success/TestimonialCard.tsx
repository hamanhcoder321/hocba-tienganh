    ...
    <div className="relative flex h-full select-none flex-col rounded-[24px] border-2 border-[#FFDFDF] bg-white p-6 shadow-[12px_12px_28px_0px_#FFBEBE80] md:p-8">
      <div className="mb-6 flex items-start justify-between">
        <div className="flex items-center gap-4">
          <div className="h-16 w-16 flex-shrink-0 overflow-hidden rounded-full border-2 border-[#F3C650] md:h-20 md:w-20">
            <img width={150} height={150} src={avatar} alt={name} className="h-full w-full object-cover" />
          </div>
          <div>
